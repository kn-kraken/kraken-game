...
export default function StatusBar({
	...
	const getStatusColorClass = () => {
		if (percentage > 60) return "bg-green-400"; // Green
		if (percentage > 30) return "bg-yellow-400"; // Yellow
	...
	return (
		<div className="flex items-center gap-3 font-semibold text-sm text-white">
			{/* Status Label */}
			<div className="min-w-20 text-black text-left capitalize">
				{label}
			</div>

			{/* Status Bar */}
			<div className="flex-1 h-5 bg-gray-700 rounded-xl overflow-hidden relative border border-white/10 min-w-40">
				<motion.div
